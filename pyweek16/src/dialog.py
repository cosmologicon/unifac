...
train = {
	...
	1: [
		"Not bad. Now let's unlock some nodes. Nodes are any tile larger than 1x1. Larger nodes are harder to unlock, so I recommend starting with a 2x2 node.",
		"To unlock a node, you have to activate it and keep it activated for a certain amount of time.",
		...
		"Once you have a node activated, click on it to begin the unlocking procedure.",
	],
	2: [
		"Learn to use items.",
	],
