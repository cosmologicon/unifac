...
function ScrollingInventoryMenu(callback) {
	...
	// TODO: show left/right/menu? what does this do?
...
ScrollingInventoryMenu.prototype = {
	...
	set_mouse: function (mpos) {
		this.mouse_x = mpos[0]
		this.mouse_y = settings.scr_h - mpos[1]
		
		if (this.menu_popup) {
			this.menu_popup.handlemouse(this.mouse_x, this.mouse_y)
			// TODO: set_right
		} else {
	...
	// TODO scroll on mouse drag and scroll wheel
	
	// TODO key press

	
	popupmenu: function (choices, header) {
		// TODO: I'm just sort of guessing about these options
	...
	position_icons: function () {
		...
		this.icon_per_row = INVMENU_ICON_PERROW  // TODO: this assumes this is defined
