...
resources from the surface or from
Extractors"""

buildextractor = """Monopole Extractor
Extracts magnetic monopoles from the
interior, which must be picked up by
collection bots."""
...
Hold Shift or press Caps Lock to reverse this behavior.
